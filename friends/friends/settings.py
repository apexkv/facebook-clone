...
SECRET_KEY = "django-insecure-wi^$%6&orkam(e7x%o)nm4l*#)f&wc+bha$3qf**(7*!hyw=j5"
...
# Database
# https://docs.djangoproject.com/en/5.0/ref/settigs/#databases
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ("friendship.middleware.UserAuthentication",),
