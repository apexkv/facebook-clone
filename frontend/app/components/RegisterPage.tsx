				...
				<div className="w-1/2 flex items-center justify-end">
					<div className="w-4/5 bg-white shadow-xl rounded-lg p-4">
						<Formik initialValues={initialValues} onSubmit={submitRegister} validationSchema={loginSchema}>
							<Form>
								<div className="py-2">
									<Field type="text" name="full_name" className="w-full border p-4 text-xl rounded-md" placeholder="Full Name" autoComplete="name" />
									<ErrorMessage name="full_name" component="div" className="text-red-500 text-sm px-1" />
								</div>
								<div className="py-2">
									<Field type="email" name="email" className="w-full border p-4 text-xl rounded-md" placeholder="Email" autoComplete="email" />
								...
								<div className="py-2">
									...
									/>
									<ErrorMessage name="password" component="div" className="text-red-500 text-sm px-1" />
								</div>
								<div className="py-2">
									<Field
										type="password"
										...
										autoComplete="current-password"
									/>
									<ErrorMessage name="password_confirm" component="div" className="text-red-500 text-sm px-1" />
								</div>
								<button type="submit" className="w-full p-3 mt-4 bg-blue-600 text-xl font-medium rounded-md text-white">
									Sign up
								</button>
								<div className="w-full flex flex-col items-center">
									<Hr color="bg-black" my={8} />
									<Link href={'/login'} className="bg-green-500 mt-2 text-center w-fit font-medium text-white px-8 py-2 rounded-md">
										Login
									</Link>
								</div>
							</Form>
